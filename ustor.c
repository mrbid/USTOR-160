...
would seem a suitable memory requirement to ensure IDFA's are kept for around
24 hours.

The buffer write is cyclic/ring buffer so that the oldest IDFA's are the first to be forgotten
